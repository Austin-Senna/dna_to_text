...
| encoder | pooling | feature_source | test_macro_f1 | delta_f1_vs_4mer | test_kappa | delta_kappa_vs_4mer | test_accuracy | delta_accuracy_vs_4mer | C | timestamp | task | shuffled_labels |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
